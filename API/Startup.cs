    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(swagger =>
            {
                ...
                {
                    Version = "v1",
                    Title = "ASP.NET 3 Web API",
                    Description = "Authentication and Authorization in ASP.NET 3 with JWT and Swagger"
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ASP.NET 3 Web API v1"));
